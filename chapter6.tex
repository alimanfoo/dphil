...
%
\footnotetext{Codon numbering is given relative to \agam\ transcript \texttt{AGAP004707-RA} in gene annotation set AgamP4.4. A mapping to \textit{Musca domestica} codon numbers is given in Table~\ref{table:snps}.}
%
